...
namespace HIQTrainingSite.ViewModel {
    public class CourseLocationViewModel {
        ...
        public CourseLocationViewModel()
        {
        ...
        [Display(Name = "labelCourseLocationName", ResourceType = typeof(HIQResources))]
        ...
        [Display(Name = "labelDisplayColor", ResourceType = typeof(HIQResources))]
